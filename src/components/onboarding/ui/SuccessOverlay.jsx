...
const SuccessOverlay = ({ applicationNumber }) => {
  ...
  return (
    <div className="fixed inset-0 bg-[#302F2D]/98 flex flex-col gap-6 sm:gap-10 md:gap-14 [@media(max-height:700px)]:gap-6 items-center justify-center z-[9999] animate-in fade-in duration-500 p-4 overflow-y-auto">
      <h1
