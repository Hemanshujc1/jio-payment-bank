...
const OnboardingHeader = () => {
  return (
    <>
      {/* On-Boarding Mode */}
      <div className="flex flex-col sm:flex-row justify-center items-center gap-2 sm:gap-4 mb-10 text-center sm:text-left">
      ...
      <div className="mb-10 flex flex-col sm:flex-row items-center sm:items-start gap-1 sm:gap-2 text-center sm:text-left">
