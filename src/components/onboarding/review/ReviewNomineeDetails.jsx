  ...
  if (data?.provide === "No") {
    return (
      <section className="w-full relative px-1 sm:px-0">
        ...
        <div className="flex flex-col items-center justify-center p-6 bg-amber-50/30 border border-dashed border-[#A89885]/30 rounded-2xl text-center">
          <div className="w-10 h-10 bg-amber-100/50 rounded-full flex items-center justify-center mb-3">
          ...
          <h4 className="font-bold text-[14px] sm:text-[15px] text-gray-800 mb-1">No Nominee Declared</h4>
          <p className="text-[12px] text-gray-500 max-w-md">
            The applicant has chosen not to declare a nominee for this account.
          </p>
        </div>
      </section>
    );
